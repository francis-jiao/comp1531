...
def login():
    ...
    if request.method == 'POST':
        customer = system.login_customer(request.form['username'], request.form['password'])
...
#####################################################
        ...
        errors = system.make_booking(current_user, car, location, request.form['start_date'], request.form['end_date'])
        if errors:
            return render_template('booking_form.html', errors=errors)
...
######################################################
            if 'check' in request.form:
                ...
                location = Location(request.form['start'], request.form['end'])
                ######
                booking  = system.make_booking(current_user,car, location,start_date,end_date)
